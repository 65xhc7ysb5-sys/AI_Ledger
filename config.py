...
MONTHLY_INCOME           = int(os.getenv("MONTHLY_INCOME",           0))
CURRENT_INVESTMENT       = int(os.getenv("CURRENT_INVESTMENT",       0))
CURRENT_JEONSE_DEPOSIT   = int(os.getenv("CURRENT_JEONSE_DEPOSIT",   0))
CURRENT_SAVINGS_DEPOSIT  = int(os.getenv("CURRENT_SAVINGS_DEPOSIT",  0))
MONTHLY_SAVING_TARGET    = int(os.getenv("MONTHLY_SAVING_TARGET",    0))
TARGET_EQUITY            = int(os.getenv("TARGET_EQUITY",            300_000_000))
TARGET_PRICE_LOW         = int(os.getenv("TARGET_PRICE_LOW",         500_000_000))
TARGET_PRICE_HIGH        = int(os.getenv("TARGET_PRICE_HIGH",        600_000_000))
VARIABLE_BUDGET_LIMIT    = int(os.getenv("VARIABLE_BUDGET_LIMIT",    0))
TARGET_PURCHASE_PRICE    = int(os.getenv("TARGET_PURCHASE_PRICE",    500_000_000))
RETIREMENT_YEAR          = int(os.getenv("RETIREMENT_YEAR",          2050))
CURRENT_AGE              = int(os.getenv("CURRENT_AGE",              35))
